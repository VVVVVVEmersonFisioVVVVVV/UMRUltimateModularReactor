...
local tint1 = {r = 0.1, g = 0.1, b = 0.1, a = 1}
local tint2 = {r = 1, g = 1, b = 1, a = 1}
...
data:extend({
    {
        name = 'umr_heavyforge_entity',
        type = 'item',
        icons = {{icon = "__ultimateCore__/graphics/umr_machine/umr_machine_icon.png", icon_size = 64, tint = {r = 0.4, g = 0.4, b = 0.4, a = 1}}},
        place_result = 'umr_heavyforge_entity',
        stack_size = 20,
        subgroup = 'umr_item_subgroup_g',
        order = 'a-a',
    ...
    },
    {
        ...
        results = {
            {type="item", name="umr_heavyforge_entity", amount=1},
        },
        energy_required = 10,
    },
    {
