...
data:extend({
    {
        name = 'umr_output_entity',
        type = 'item',
        icons = {{icon = "__ultimateCore__/graphics/umr_amplifier/umr_amplifier_icon.png", icon_size = 64, tint = {r = 0.9, g = 0.5, b = 0.9, a = 1}}},
        place_result = 'umr_output_entity',
        stack_size = 20,
        subgroup = 'umr_item_subgroup_d',
        order = 'a-a',
    ...
    },
    {
        ...
        results = {
            {type="item", name="umr_output_entity", amount=1},
        },
        energy_required = 10,
    },
    {
        ...
        minable = {
            mining_time = 5,
            result = 'umr_output_entity',
        },
        crafting_categories = {'umr_output_category'},
        crafting_speed = 1,
        resistances =
        {
            {
