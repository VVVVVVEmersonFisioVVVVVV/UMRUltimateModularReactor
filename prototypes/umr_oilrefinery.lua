...
local tint = {r = 1, g = 0.5, b = 0.3, a = 1}
...
data:extend({
    {
        name = 'umr_oilrefinery_entity',
        type = 'item',
        icons = {{icon = "__ultimateCore__/graphics/umr_machine/umr_machine_icon.png", icon_size = 64, tint = {r = 1, g = 0.5, b = 0.3, a = 1}}},
        place_result = 'umr_oilrefinery_entity',
        stack_size = 20,
    ...
    },
    {
        ...
        results = {
            {type="item", name="umr_oilrefinery_entity", amount=1},
        },
        energy_required = 10,
    },
    {
