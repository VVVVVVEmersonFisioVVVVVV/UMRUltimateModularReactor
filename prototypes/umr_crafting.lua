...
local tint1 = {r = 0.6, g = 0.9, b = 0, a = 1}
local tint2 = {r = 0.1, g = 0.4, b = 0.1, a = 1}
...
data:extend({
    {
        name = 'umr_crafting_entity',
        type = 'item',
        icons = {{icon = "__ultimateCore__/graphics/umr_machine/umr_machine_icon.png", icon_size = 64, tint = {r = 0.6, g = 0.9, b = 0, a = 1}}},
        place_result = 'umr_crafting_entity',
        stack_size = 20,
        subgroup = 'umr_item_subgroup_h',
        order = 'a-a',
    ...
    },
    {
        ...
        results = {
            {type="item", name="umr_crafting_entity", amount=1},
        },
        energy_required = 10,
    },
    {
        ...
        icons_positioning =
        {
          {inventory_index = defines.inventory.assembling_machine_modules, shift = {0, 0.8}, max_icons_per_row = 10}
        },
    ...
    graphics_set = {
      ...
      working_visualisations = {{
        ...
        working_sound = { 
            sound = { filename = '__base__/sound/assembling-machine-t3-2.ogg'},
            idle_sound = { filename = "__base__/sound/idle1.ogg", volume = 0.6 },
            apparent_volume = 0.7,
        },
    },
    {
        name = 'umr_crafting_entity_2',
        type = 'item',
        icons = {{icon = "__ultimateCore__/graphics/umr_machine/umr_machine_icon.png", icon_size = 64, tint = {r = 0.1, g = 0.5, b = 0.1, a = 1}}},
        place_result = 'umr_crafting_entity_2',
        stack_size = 20,
        subgroup = 'umr_item_subgroup_h',
        order = 'a-b',
        inventory_move_sound = item_sounds.reactor_inventory_move,
    ...
    },
    {
        ...
        ingredients = {
            ...
            {type="item", name="umr_heavyforge_entity", amount=10},
            {type="item", name="umr_crafting_entity", amount=10},
            {type="item", name="umr_furnace_entity", amount=10},
            {type="item", name="umr_oilrefinery_entity", amount=10},
            {type="item", name="umr_chemicalplant_entity", amount=10},
        },
        results = {
            {type="item", name="umr_crafting_entity_2", amount=1},
        },
        energy_required = 10,
    },
    {
